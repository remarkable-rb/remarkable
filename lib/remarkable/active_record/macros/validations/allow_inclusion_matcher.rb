module Remarkable # :nodoc:
  module ActiveRecord # :nodoc:
    module Matchers # :nodoc:
      class AllowInclusionMatcher < Remarkable::Matcher::Base
        ...
        def load_options(options)
          @options = {
            :message => default_error_message(@behavior)
          }.merge(options)
        end
      ...
      #
      # Example:
      #   it { should allow_inclusion_of(:isbn, "isbn 1 2345 6789 0", "ISBN 1-2345-6789-0") }
      #   it { should_not allow_inclusion_of(:isbn, "bad 1", "bad 2") }
      #
      def allow_inclusion_of(attribute, *good_values)
        AllowInclusionMatcher.new(attribute, :inclusion, *good_values)
      end
      ...
      #
      # Example:
      #   it { should ensure_exclusion_of(:username, "admin", "user") }
      #   it { should_not ensure_exclusion_of(:username, "dhh", "peter_park") }
      #
      def ensure_exclusion_of(attribute, *good_values)
        AllowInclusionMatcher.new(attribute, :exclusion, *good_values)
      end
    end
  end
end
