...
Remarkable makes it easy to write elegant, understandable, and maintainable tests.  Remarkable consists of test macros, assertions, and helpers added on to the Test::Unit framework.  It's fully compatible with your existing tests, and requires no retooling to use.
...
Remarkable is maintained by {Carlos Brando}[mailto:remarkable@carlosbrando.com]
